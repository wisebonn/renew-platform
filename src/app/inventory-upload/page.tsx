    ...
    <main className="w-full">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
          <h3 className="text-lg font-bold text-slate-400 uppercase tracking-wider mb-4">Upload Master Netstock Spreadsheet</h3>
          <input 
            type="file" 
            accept=".xlsx,.xls" 
          ...
          />
          {isLoading && <p className="mt-4 text-slate-400">Processing...</p>}
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-slate-400">Pump Ends</h3>
            <p className="text-4xl font-bold">{categoryCounts.PUMP_END} Models</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-slate-400">Motors</h3>
            <p className="text-4xl font-bold">{categoryCounts.MOTOR} Models</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-slate-400">Pump C/W Motor</h3>
            <p className="text-4xl font-bold">{categoryCounts.PUMP_CW_MOTO} Models</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-slate-400">Inverters/Sunverters</h3>
            <p className="text-4xl font-bold">{categoryCounts.INVERTER} Models</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-slate-400">Solar Panels</h3>
            <p className="text-4xl font-bold">{categoryCounts.SOLAR_MODULE} Models</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-slate-400">Piping Arrays</h3>
            <p className="text-4xl font-bold">{categoryCounts.PIPE} Models</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg shadow-xl">
            <h3 className="text-lg font-bold text-slate-400">Cables</h3>
